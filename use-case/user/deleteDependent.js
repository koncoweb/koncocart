...
const getDependencyCount = ({
  ...
  if (user.length){
    ...
    const produkFilter = { '$or': [{ addedBy : { '$in' : userIds } },{ updatedBy : { '$in' : userIds } }] };
    const produkCnt =  await produkDb.count(produkFilter);
...
const deleteWithDependency = ({
  ...
  if (user.length){
    ...
    const produkFilter = { '$or': [{ addedBy : { '$in' : userIds } },{ updatedBy : { '$in' : userIds } }] };
    const produkCnt =  (await produkDb.destroy(produkFilter)).length;
...
const softDeleteWithDependency = ({
  ...
  if (user.length){
    ...
    const produkFilter = { '$or': [{ addedBy : { '$in' : userIds } },{ updatedBy : { '$in' : userIds } }] };
    const produkCnt =  (await produkDb.update(produkFilter,updateBody)).length;
